...
DTBNAME_jetson-xavier-nx-devkit-seeed-2mic-hat = "tegra194-p3668-all-p3509-0000-seeed-2mic-hat"
...
do_configure() {
    ...
    # For the 32.4.4 release, /opt/tegra-binaries/boot0.img MD5 should be 53a472b624645c570ed14635b4c6a8f2
