...
SRC_URI = "https://developer.nvidia.com/embedded/l4t/r34_release_v1.1/sources/nvidia-l4t-jetson-uefi-source.tbz2"
SRC_URI[sha256sum] = "616ac2c4596a795b23f9017a787780ca1f7a521cd1967caa24da4387b9d9140b"

SRC_URI += "file://0001-Fix-VLA-parameter-warning.patch"
SRC_URI += "file://0002-Replace-libc-mem-calls-with-EDK2-defined-calls.patch"

SRC_URI += " \
	file://0001-Ext4Pkg-Add-symbolic-links-support.patch \
	file://0001-Try-symlink.patch \
	file://0001-load-file-test.patch \
	file://0002-Ext4Pkg-Add-base-containing-record-macro-for-EXT4_FI.patch \
	file://0001-Fix-pitch.patch \
"
...
do_deploy() {
    ...
    cp ${B}/images/BOOTAA64.efi ${DEPLOY_DIR_IMAGE}/bootfiles/BOOTAA64.efi
}
