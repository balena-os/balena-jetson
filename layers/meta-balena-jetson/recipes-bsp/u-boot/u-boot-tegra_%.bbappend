FILESEXTRAPATHS:prepend := "${THISDIR}/${PN}:${THISDIR}/32.7.6:"
...
# that were introduced by 32.7.1 -> 32.7.6.
# As of today, 4335beb69 tegra: config: update TX2-NX uboot env offset
# is still the last commit in the 32.7.6 branch
SRC_URI:append = " \
